...
export default function TodoList() {
  ...
  return (
    ...
    <div className="max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex" style={{ paddingTop: '100px' }}>
            <div className="mt-8 mx-auto">
              <h2 className="text-3xl font-semibold mb-7">To-Do List</h2>
              ...
              <li key={index} className="mb-3">
                {editingIndex === index ? (
                  ...
                  <>
                    ...
                    <button onClick={() => startEdit(index)} className="px-2 ml-20 bg-blue-500 text-white rounded">
                      Edit
                    </button>
                    <button onClick={() => deleteTodo(index)} className="px-2 ml-3 bg-red-500 text-white rounded">
                      Delete
                    </button>
                  </>
                )}
